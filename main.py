...
def main():
    ...
    # training with blurring and erasing
    # transform_train = transforms.Compose([
    # transforms.RandomCrop(32, padding=4),
    # transforms.RandomHorizontalFlip(),
    ...
    # transforms.ToTensor(),
    # transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010)),  # Add random noise with a probability of 0.5
    # ])
...
if __name__ == '__main__':
    multiprocessing.freeze_support()  # Only needed for Windows
    main()
